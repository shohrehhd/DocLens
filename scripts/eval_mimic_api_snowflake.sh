...
SHOT=6
DEFAULT_SAVENAME=mimic-sample200-${MODEL}-shot${SHOT}-quick_test3
...
python claim_evaluation/generate_subclaims.py --eval_file data/mimic-sampled200_clean.json \
    ...
    --prompt_file claim_evaluation/prompts/mimic_subclaim_generation.json --provider snowflake
...
python claim_evaluation/run_entailment.py --result_file results/${SAVENAME}.claim_min1max30.json \
    ...
    --prompt_file claim_evaluation/prompts/mimic_claim_entail.json --provider snowflake
...
python citation_evaluation/eval_citation.py --result_file results/${SAVENAME}.json \
    ...
    --prompt_file citation_evaluation/prompts/mimic_citation_entail.json --provider snowflake

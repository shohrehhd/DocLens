...
python claim_evaluation/run_entailment.py --result_file results/${SAVENAME}.json \
    ...
    --prompt_file claim_evaluation/prompts/meqsum_claim_entail.json
...
python claim_evaluation/run_entailment.py --result_file results/${SAVENAME}.json \
    ...
    --prompt_file claim_evaluation/prompts/meqsum_claim_entail_same.json

# eval citations
python citation_evaluation/eval_citation.py --result_file results/${SAVENAME}.json \
    --dataset_name meqsum --split_method sent \
    --prompt_file citation_evaluation/prompts/meqsum_citation_entail.json
